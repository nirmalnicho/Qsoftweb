                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                                <!-- Copyright Left -->
                                <div class="copyright-left">&copy; <script>document.write(new Date().getFullYear());</script> Q Soft Web. All rights reserved.</div>
                                <!-- Copyright Right -->
                                <div class="copyright-right">Developed By <i class="fas fa-wrench" style="color: red;"></i>
                                <a href="https://www.facebook.com/share/16Pr6gP36h/">Nirmal Nicholas Fonseka</a></div>
                            </div>
                        </div>
                    </div>
                </div>
